...
var initialData = {
  ...
  configurationItems: [
    ...
    {type: "Clothes", fileName: "ColorHoodie.png", x: 900, y: 400, h: 320, w: 250, draggable: true, xOffset: 75, yOffset: 82, zIndex: 22,},
    {type: "Clothes", fileName: "LeatherVest.png", x: 900, y: 400, h: 260, w: 195, draggable: true, xOffset: 98, yOffset: 115, zIndex: 23,},
    {type: "Clothes", fileName: "RedDress.png", x: 900, y: 400, h: 350, w: 450, draggable: true, xOffset: -12, yOffset: 180, zIndex: 21,},
  ...
  currentItems: [ 
    {id: 1, x: 450, y: 160, imageSrc: getImg('Nobody'), imageHighlightedSrc: getImg('SammiEating1'), h: 600, w: 400, type: 'Body', desc: 'Sammi', draggable: false,
      bodies: [
        ...
        {fatLevel: 0, imageSrc: getImg('Cookie4'), imageHighlightedSrc: getImg('SammiEating1'), bodyType: 'COOKIE',},
        {fatLevel: 4, imageSrc: getImg('FatCookie5'), imageHighlightedSrc: getImg('FatSammiEating3'), bodyType: 'COOKIE',},
        {fatLevel: 100, imageSrc: getImg('FatCookie6'), imageHighlightedSrc: getImg('FatSammiEating4'), bodyType: 'COOKIE',},
